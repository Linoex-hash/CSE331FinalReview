...
\begin{document}
    ...
    \begin{frame}{Introduction}
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                produces a \textbf{locally} optimal solution. The goal is to achieve \textbf{polynomial time} for the algorithm.}
                \bigskip
    ...
    \begin{frame}{Interval Scheduling Problem}
        ...
        do you pick the \textbf{maximum} number of tasks that aren't in conflict?}
        \bigskip

        \onslide<2->{There are numerous greedy algorithms:}
        \begin{itemize}
